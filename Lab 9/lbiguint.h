...
public:
    ...
    // pre: none
    // post: clears lbiguint and returns dynamically allocated memory to heap
    ~lbiguint();
    ...
    unsigned short operator [](std::size_t pos);
    //
    // // pre: none
    ...
    // pre: none
    // post: adds given lbiguint to this lbiguint
    void operator +=(const lbiguint &);
...
lbiguint operator +(const lbiguint & a, const lbiguint & b);
